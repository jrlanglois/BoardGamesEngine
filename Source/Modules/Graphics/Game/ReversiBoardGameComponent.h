...
#define BGE_REVERSI_BOARD_GAME_COMPONENT_H

#include "ReversiTileBoardComponent.h"

class ReversiBoardGameComponent : public BoardGameComponent
{
public:
    ReversiBoardGameComponent (BoardGame& boardGame,
    ...
    //==============================================================================
    /** @internal */
    PlayerView* createPlayerView (bool forFirstPlayer) override;
    /** @internal */
    TileBoardComponent* createTileBoardComponent() override;

private:
    //==============================================================================
    class ReversiPlayerComponent;

    //==============================================================================
    ReversiBoardGameComponent() BGE_DELETED_FUNCTION;
    BGE_DECLARE_NON_COPYABLE (ReversiBoardGameComponent)
};
